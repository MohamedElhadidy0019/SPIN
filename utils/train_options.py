...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--num_epochs', type=int, default=11, help='Total number of training epochs')
        ...
        train.add_argument('--rot_factor', type=float, default=0, help='Random rotation in the range [-rot_factor, rot_factor]') 
        train.add_argument('--noise_factor', type=float, default=0, help='Randomly multiply pixel values with factor in the range [1-noise_factor, 1+noise_factor]') 
        train.add_argument('--scale_factor', type=float, default=0, help='Rescale bounding boxes by a factor of [1-scale_factor,1+scale_factor]') 
